...
export default function HowItWorksPage() {
  return (
    <Section className="pt-32">
      <Container>
        <h1 className="text-5xl font-bold tracking-tight mb-6">How CARE360 Works</h1>
        <p className="text-xl text-muted-foreground">The foundation of a connected healthcare ecosystem.</p>
